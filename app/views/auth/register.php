...
<body>
    <header>
        ...
        <nav class="navbar">
            ...
            <ul class="liste_droit">
                <li style="display: flex; justify-content: center; align-items: center;"><i class="fa-solid fa-user" style="color: #5ABDF1;"></i><a href="#" class="border_droit active">Se Connecter</a></li>
    ...
    <section class="section_contact">
        <div class="titre_section" style="justify-content: center;"><h1>Créer un Compte</h1></div>
        <div class="form_contenair">
            ...
            <div><input type="text" placeholder="Votre Email ex : mouad123@gmail.com"></div>
            <div><input type="text" placeholder="Votre mot de passe"></div>
            <div><input type="text" placeholder="Confirmer Votre mot de passe"></div>
            <div>
                <select name="" id="">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;padding: 0 100px 0 70px; font-size: .8rem;">
                <a href="#" style="color: green; font-weight: 600;">J'ai déjà un compte !</a>
                <a href="home.php#contact_section" style="color: red;">Aide</a>
            </div>
