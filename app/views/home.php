...
<body>
        ...
        <div class="contenair_fonctionnalites">
            <div class="fonctionnalite">
                ...
                <div class="pas_contenair">
                    ...
                    <div class="auth_pas"><img src="/php_briefs/Minerva_binomes/public/imgs/auth.png" alt=""></div>
                </div>
            </div>
            <div class="fonctionnalite" style="position: relative;">
                ...
                <div class="pas_contenair">
                    ...
                    <div class="auth_pas" style="position: absolute; width: 120px; bottom: 0;right: 0;"><img
                            src="/php_briefs/Minerva_binomes/public/imgs/taches.png" alt=""></div>
                </div>
            </div>
            <div class="fonctionnalite">
                <div class="fontionnalite_entete">
                ...
                <div class="pas_contenair">
                    ...
                    <div class="auth_pas" style="width: 100px;"><img
                            src="/php_briefs/Minerva_binomes/public/imgs/chat-removebg-preview.png" alt="">
                    </div>
                </div>
            </div>
            <div class="fonctionnalite">
                ...
                <div class="pas_contenair">
                    ...
                    <div class="auth_pas"><img src="/php_briefs/Minerva_binomes/public/imgs/stat.png" alt=""></div>
                </div>
            </div>
        </div>
    </section>
    <section>
        <div class="titre_contenair">
            <div class="titre_section titre_gauche">
